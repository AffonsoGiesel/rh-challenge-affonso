...
class FuncionariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create funcionario" do
    assert_difference('Funcionario.count') do
      post funcionarios_url, params: { funcionario: { cargo: @funcionario.cargo, data_nascimento: @funcionario.data_nascimento, lotacao: @funcionario.lotacao, matricula: @funcionario.matricula, nome: @funcionario.nome, sexo: @funcionario.sexo } }
    end
  ...
  test "should update funcionario" do
    patch funcionario_url(@funcionario), params: { funcionario: { cargo: @funcionario.cargo, data_nascimento: @funcionario.data_nascimento, lotacao: @funcionario.lotacao, matricula: @funcionario.matricula, nome: @funcionario.nome, sexo: @funcionario.sexo } }
